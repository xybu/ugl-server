...
class Hybrid_Providers_Facebook extends \hybrid\Hybrid_Provider_Model
{
	...
	*/
	function initialize() 
	{
		...
		if ( ! class_exists('FacebookApiException', false) ) {
			require_once \hybrid\Hybrid_Auth::$config["path_libraries"] . "Facebook/base_facebook.php";
			require_once \hybrid\Hybrid_Auth::$config["path_libraries"] . "Facebook/facebook.php";
		}
		
		if ( isset ( \hybrid\Hybrid_Auth::$config["proxy"] ) ) {
	...
	*/
	function loginBegin()
	{
		...
		\hybrid\Hybrid_Auth::redirect( $url );
	}
	...
	*/
	function getUserContacts()
	{
		...
		foreach( $response["data"] as $item ){
			$uc = new \hybrid\Hybrid_User_Contact();
	...
	*/
	function getUserActivity( $stream )
	{
		...
		foreach( $response['data'] as $item ){
			...
			$ua = new \hybrid\Hybrid_User_Activity();
